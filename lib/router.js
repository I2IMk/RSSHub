...
// avgle
router.get('/avgle/videos/:order?/:time?/:limit?', require('./routes/avgle/videos.js'));
router.get('/avgle/search/:keyword/:order?/:time?/:limit?', require('./routes/avgle/videos.js'));
